  ...
  <div class="income-container">
    ...
    <el-card class="search-card">
      <el-form :inline="true" :model="searchForm">
        <el-form-item label="收入類型">
          <el-select v-model="searchForm.type" placeholder="請選擇" clearable>
            <el-option label="課程收入" value="course" />
            <el-option label="教材收入" value="material" />
    ...
    <el-card>
      <el-table :data="incomeList" style="width: 100%" v-loading="loading">
        ...
        <el-table-column prop="type" label="收入類型" width="120">
        ...
        <el-table-column prop="source" label="來源" width="180" />
    ...
    <!-- 收入編輯對話框 -->
    <el-dialog
      :title="dialogType === 'add' ? '新增收入' : '編輯收入'"
...
const rules = {
  ...
  source: [
    { required: true, message: '請輸入來源', trigger: 'blur' }
  ]
}
